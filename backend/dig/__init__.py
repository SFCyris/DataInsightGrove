...
A hardcoded ``__version__`` literal would drift away from pyproject's
declared version every time someone bumped one and forgot the other.
``importlib.metadata.version("dig")`` reads from the installed
