...
![Catalog — column-aware edges between pipelines](images/workspace/06-catalog-column-edges.png)
...
![Catalog tag filter — chip strip filters the live canvas](images/workspace/10-catalog-tags.png)
...
![Sankey view of a pipeline — zoom + pan + per-band tooltip](images/workspace/02-sankey-zoom-pan.png)
...
![Column DNA — bipartite layout, drawer view](images/workspace/03-dna-zoom-pan.png)
...
![Column DNA — downstream walk view](images/workspace/04-dna-downstream-walk.png)
...
![Impact badge — surfaced on column-rename / drop / recast](images/workspace/05-impact-badge.png)
