...
backend/.venv/bin/python Step-Pack-internal/packs/geospatial_pack/_build/build.py

# Repackage data.zip + update pack.json hashes
backend/.venv/bin/dig-pack build Step-Pack-internal/packs/geospatial_pack
```
